	...
	*/
	public function get_columns(){
		$columns = array(
			...
			'title' => __( 'Title', 'info-popup' ),
			'shortcode' => __( 'Shortcode', 'info-popup' ),
			'author' => __( 'Author', 'info-popup' ),
			'date' => __( 'Date', 'info-popup' ),
		);
	...
	$list = new IP_List_Table();

	
	public function prepare_items() {
		$current_screen = get_current_screen();
		$per_page = $this->get_items_per_page( 'ip_shortcode_per_page' );
...
// 			esc_attr( sprintf( __( 'Edit &#8220;%s&#8221;', 'info-popup' ),
// 				$item->title() ) ),
// 			esc_html( $item->title() )
// 		);
...
// 		$actions = array(
// 			'edit' => wpcf7_link( $edit_link, __( 'Edit', 'info-popup' ) ),
// 		);
...
// 				'copy' => wpcf7_link( $copy_link, __( 'Duplicate', 'info-popup' ) ),
// 			) );
// 		}
...
// 		$t_time = mysql2date( __( 'Y/m/d g:i:s A', 'info-popup' ),
// 			$post->post_date, true );
...
// 			);
// 		} else {
// 			$h_time = mysql2date( __( 'Y/m/d', 'info-popup' ), $m_time );
// 		}
